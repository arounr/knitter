...
export const EditForm = ({ color0, name0, pattern0, isPublic0, id }: { color0: Array<string>, name0: string, pattern0: Array<Array<number>>, isPublic0: boolean, id: number }) => {
  ...
  return (
    <>
      <ColorMatrixTable matrix={pattern} colors={color} onCellClick={handleCellClick} />
      <Form action={(formData: FormData) => {
        ...
        <div className="flex items-center">
          ...
          <input type="checkbox" id="public" name="public" defaultValue={isPublic ? 'on' : 'off'} onChange={(e) => setIsPublic(e.target.value === 'on')} />
        </div>
